blank_logo = "images/blank.png"
cross_logo = "images/cross.png"
tick_logo  = "images/check.png"
draw_gif   = "images/draw.gif";
win_gif    = "images/congo.gif";
...
function im_click(id)
{
    ...
    if(stat == 1 || stat == 0)
    {
        ...
        document.getElementById("anim").src=win_gif;
    ...
    else if(stat == -2)
    {
        ...
        document.getElementById("anim").src = draw_gif;
